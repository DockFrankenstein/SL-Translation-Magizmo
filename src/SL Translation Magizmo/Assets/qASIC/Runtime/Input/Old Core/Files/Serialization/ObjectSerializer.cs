...
namespace qASIC.Files.Serialization
{
    ...
    public class ObjectSerializer
    {
        ...
        { 
            get
            {
                if (_providerTypes == null)
                    _providerTypes = TypeFinder.FindAllTypes<SerializationProvider>().ToList();
        ...
        {
            var providers = TypeFinder.CreateConstructorsFromTypes<SerializationProvider>(ProviderTypes).ToList();
