...
namespace qASIC.Input.DebugTools
{
    public class InputDebug : EditorWindow
    {
        ...
        {
            Page = GUILayout.SelectionGrid(Page, new string[] { "Utility", "UIM", "Map Data", "Key List", "Cursor", "Info" }, 1, Styles.MenuSelection);
        }
            ...
            switch (Page)
            {
                ...
                case 5:
                    using (new EditorGUI.DisabledGroupScope(true))
                        EditorGUILayout.ObjectField("Input Manager Map", InputManager.Map, typeof(Map.InputMap), false);
                    break;
            }
        }
